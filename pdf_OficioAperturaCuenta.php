      ...
      <table border="0" width="800">
            <tbody>
             <tr>
                ...
                <td style="width:20%;">Apellido y Nombres:<h2><?php if (isset($_POST['txtcedula'])): ?><?= $_POST['txtcedula'] ?><?php endif; ?> </h2> </td>
								<td style="width:20%;">Fecha Nacimiento:<h2><?php if (isset($_POST['txtcedula'])): ?><?= $_POST['txtcedula'] ?><?php endif; ?> </h2> </td>
           </tr>
            <tr>
